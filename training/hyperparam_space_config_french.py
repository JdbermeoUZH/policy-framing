...
MODEL_LIST = \
    {
        ...
        'RakelD_LogisticRegression': {
            ...
            'hyperparam_space': {
                ...
                'model__base_classifier__C': loguniform(1e-6, 1e-2),
        ...
        'RakelD_SVM': {
            ...
            'hyperparam_space': {
                ...
                'model__base_classifier__gamma': loguniform(1e-4, 500),
                'model__base_classifier_require_dense': [False],
                'model__labelset_size': range(1, 6)
            }
        },
        ...
        'LinearSVMDual': {
            ...
            'hyperparam_space': {
                'preproc__with_std': [True],
                'model__C': loguniform(2e-5, 1.5e-3)
            }
        },
        ...
        'LinearSVMDual_BorderlineSMOTE': {
            ...
            'hyperparam_space': {
                'preproc__with_std': [True],
                'model__C': loguniform(1e-5, 1.5e-3),
                'model__class_weight': ['balanced'],
                'up__sampling_strategy': ['minority', 'not minority', 'not majority'] + up_sampling_prop_list,
                'up__k_neighbors': randint(min(min_samples_min_class - 1, 3), min_samples_min_class),
                'up__m_neighbors': randint(3, 30),
        ...
        'RakelD_LinearSVM': {
            ...
            'hyperparam_space': {
                ...
                'model__base_classifier__C': loguniform(1e-5, 1.5e-3),
                'model__base_classifier_require_dense': [False],
                'model__labelset_size': range(1, 6)
            }
        },
        ...
        'NaiveBayes_ROS': {
            ...
            'model_subtype': 'Random Oversampling',
            'hyperparam_space': {
                'model__alpha': loguniform(1e-3, 1),
